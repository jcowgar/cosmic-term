...
use crate::{
    Action, Terminal, TerminalScroll, box_drawing, menu::MenuState, mouse_reporter::MouseReporter,
    terminal::Metadata,
};
    ...
    Message: Clone,
{
    ...
    fn draw(
        ...
        // Width of one terminal cell. Box-drawing glyphs are snapped to this
